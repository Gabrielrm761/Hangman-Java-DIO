...
public class HangmanGame {
    ...
    public HangmanGame(final List<HangmanChar> character) {
        var whiteSpaces = " ".repeat(character.size());
        var characterSpace = "-".repeat(character.size());
        ...
        this.characters = setCharacterSpacePositionInGame(character, whiteSpaces.length());
